...
const ItemForm = ({ item, onSuccess }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        const data = { firstname, middlename, lastname, Address,Barangay,City,State, 
            ZipCode, Religion, Sex, Age, Phone, Email,Student_No, Height, Weight, Place_of_Birth, Civil_Status,
        Course, Year, Section, Department, Subject, Citizenship, School, Facebook, Instagram, Tiktok, Twitter};
        try {
            if (item) {
                await
